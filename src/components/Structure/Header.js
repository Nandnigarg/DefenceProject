        ...
        <div className="container-fluid bg bg-success pt-2" style={{ textAlign: "center" }}>
            <div className="row pb-1">
                <div className="col-md-6">
                    <img width="100%" height="auto" style={{ maxHeight: "80px", maxWidth: "80px" }} src={dcgLogo} alt="" /><span style={{ fontSize: "2rem", fontWeight: "bold", color: "rgb(255,255,0)" }}>DCG Defence Academy</span>
                    ...
                    <div>
                        ...
                        <div className='row mb-2' style={{ fontSize: "1.7rem", textAlign: "center" }}>
                            <div className='col-sm-6 mt-2'>
                                <a href="tel:08427414076" className="text-decoration-none glow" style={{ color: "rgb(255,255,0)" }}><i class="fa-solid fa-phone"></i><span>08427414076</span></a>
                            </div>
                            <div className='col-sm-6 mt-2'>
                                <a href="https://wa.me/+918146258794" target="_blank" className="text-decoration-none glow" style={{ color: "rgb(255,255,0)" }}><i class="fa-brands fa-whatsapp"></i><span>08146258794</span></a>
                            </div>
                        </div>
                    </div>
                </div>
