    ...
    return (
        <div className="container-fluid" style={{ paddingLeft: "0", paddingRight: "0" }}>
            ...
            <div className="container mt-5 mb-5" style={{ textAlign: "justify" }}>
                ...
                <div className='row'>
                    <div className='col-sm-6' style={{ textAlign: "center" }}><iframe width="95%" height="380" src="https://www.youtube.com/embed/l_BiGgcGeiQ" title="How to Crack NDA Exam in First Attempt! | Mr. Vatsom  - DCG Academy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
                    <div className='col-sm-6' style={{ textAlign: "center" }}><iframe width="95%" height="380" src="https://www.youtube.com/embed/sU0vOD4fkQA" title="Delhi Career Group  &quot;A Network of Academic Excellence&quot; | Students Feedback| Academy Tour." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
                </div>
                <br />
                ...
                <p style={{ fontSize: "18px" }}><b><u>NDA Schooling Programme:</u></b> For students in grades 4 through 12, the NDA with Schooling Programme combines NDA training with ordinary education. Also available to pupils who have completed the 10th grade is the NDA 2-year schooling program, which offers CBSE instruction for grades 11 and 12 as well as preparation for the NDA competition. For the purpose of preparing students for the NDA competition, the program offers hostel accommodations and physical training. The curriculum combines academic achievement with physical fitness and NDA exam preparation to give kids a well-rounded education. With the help of this program, students can get a thorough education that gives them the know-how and abilities they need to succeed in both their academic and professional lives.</p>
