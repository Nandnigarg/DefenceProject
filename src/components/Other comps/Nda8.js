        ...
        <div class="container-fluid mt-5 mb-5">
            <div className="container pt-2 pb-4">
                <div style={{ textAlign: "center" }}>
                    <h1 style={{ fontFamily: "cursive", fontSize: "3.5rem", fontWeight: "bold", textAlign: "center" }} className="text text-danger">NDA After 8 Program</h1>
                    <hr />
                </div>
                <div>
                    ...
                    <p style={{ fontSize: "18px" }}>Excellence in NDA and officer entries in Defence entrance exams emphasis
                        ...
                        Preparation after 8th . Each student has the right strategy for
                        himself /herself for TIME MANAGEMENT to ensure optimum output. This
                        enables the students to excel not only in NDA but also in X and XII Board Exams.</p>
                </div>
            </div>
        </div>
    )
