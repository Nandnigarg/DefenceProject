...
function Icons(){
    return(
        <div>
            <a style={{position: "fixed", bottom: "10px", left: "20px", zIndex: "10"}} href="tel:08427414076" className="text-decoration-none text text-dark"><img height="35px" width="35px" src={Phone} alt="" /></a>
            <a style={{position: "fixed", bottom: "50px", left: "17px", zIndex: "10"}} href="https://wa.me/+918146258794" target="_blank" className="text-decoration-none text text-dark"><img height="45px" width="45px" src={WhatsApp} alt="" /></a>
