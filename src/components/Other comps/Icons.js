...
function Icons(){
    return(
        <div>
            <a style={{position: "fixed", bottom: "10px", left: "20px", zIndex: "10"}} href="tel:09876335141" className="text-decoration-none text text-dark"><img height="50px" width="50px" src={Phone} alt="" /></a>
            <a style={{position: "fixed", bottom: "70px", left: "17px", zIndex: "10"}} href="https://wa.me/+919569782865" target="_blank" className="text-decoration-none text text-dark"><img height="60px" width="60px" src={WhatsApp} alt="" /></a>
